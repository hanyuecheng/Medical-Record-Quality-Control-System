...
# 导入大模型命名实体识别模块
from llm_ner import get_llm_config, save_llm_config, recognize_entities_with_transformer, calculate_entity_statistics, TRANSFORMER_AVAILABLE, recognize_entities_with_rules
...
def recognize_llm_entities():
    ...
    try:
        ...
        if offline_mode:
            ...
            recognized_entities = recognize_entities_with_transformer(text)
...
def save_llm_config_route():
    ...
    try:
        ...
        config["use_gpu"] = 'use_gpu' in request.form
        config["offline_mode"] = 'offline_mode' in request.form
